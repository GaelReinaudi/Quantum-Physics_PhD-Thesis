...
Manipulation et refroidissement par évaporation forcée d'ensembles atomiques ultra-froids pour la production d'un jet intense dans le régime de dégénérescence quantique : vers l'obtention d'un \textit{laser à atomes continu}}
...
% pour des références en language naturel
...
\usepackage{movie15}
% hachurer du texte avec \sout{Texte à barrer}\xout{Texte à hachurer}\uwave{Texte à souligner par une vaguelette}
\usepackage[normalem]{ulem}


% pour ajouter localement une ligne à une page
...
pdfkeywords={physique,quantique,laser,atome,dégénérescence,froid,manipulation,atomique,refroidissement,évaporation,jet}}
\else % le monde DVI/PS
\fi
% ********************************************************************
...
\newcommand{\backrefcitedsinglestring}[1]{Cité à la page~#1.}
\newcommand{\backrefcitedmultistring}[1]{Cité aux pages~#1.}
