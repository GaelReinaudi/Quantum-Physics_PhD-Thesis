...
\shade[inner color=red!40,outer color=red!10] (\Znuage,0) circle(\Taillenuage);
\draw[latex'-latex']
(\Znuage-1.05*\Taillenuage,-1.1*\Taillenuage)--(\Znuage+1.05*\Taillenuage,-1.1*\Taillenuage)node[pos=0.5,below]{$\Lnuage$};
...
\draw[photon]
(\Znuage,0)++(0.9*\Taillenuage,0)--++(30:2*\LongPhoton);

\draw[photon]
(\Znuage,0)++(-0.9*\Taillenuage,0)
++(15:\LongPhoton)
++(-30:\LongPhoton)
++(60:\LongPhoton)
++(120:\LongPhoton)
