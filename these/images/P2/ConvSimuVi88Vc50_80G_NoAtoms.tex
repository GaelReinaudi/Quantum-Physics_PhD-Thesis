...
%\useasboundingbox 
%(\zminGraph*\invXscaleGraph-0.5,\vminGraph*\invYscaleGraph-0.2) 
%rectangle (\zmaxGraph*\invXscaleGraph+1.4, \vmaxGraph*\invYscaleGraph+1.1);
...
%--++(10*\invXscaleGraph, 0)
%node[right, pos=1]{atomes r�fl�chis};
