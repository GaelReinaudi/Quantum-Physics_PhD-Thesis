...
\put(\Xmin,\Ymin){\includegraphics[width=\PictureWidth cm]{Simus/Vinj88Vconv50_20G0032}}
...
\draw[latex'-](74*\invXscaleGraph,90*\invYscaleGraph)
--++(0,15*\invYscaleGraph)
node[above, pos=1]{atomes piégés};
\draw[latex'-](115*\invXscaleGraph,100*\invYscaleGraph)
...
\draw(155*\invXscaleGraph,30*\invYscaleGraph)node{$2\,\ConvBamplit=\gauss{20}$};
