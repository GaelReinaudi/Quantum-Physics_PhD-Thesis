...
\small
\tkzInit[xmin=-7,xmax=6.4,ymin=-3,ymax=0.1]
...
\fill[color=red!45!yellow](-15*\YScale,-0.4)rectangle(15*\YScale,0.4);

	\foreach \fnn/\col in {150/60, 200/75, 250/80, 300/100, 100/30, 50/15}{
		\foreach \fn in {1,...,8}{
    	\fill[rotate=-90, yscale=\YScale, color=red!\col!yellow] 
      plot file{ChampConv/ConvEquipot\fnn\fn.txt};
